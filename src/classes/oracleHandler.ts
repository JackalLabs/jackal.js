...
export class OracleHandler implements IOracleHandler {
  ...
  async getFeed (name: string): Promise<DFeed> {
    try {
      ...
      throw warnError('oracleHandler getFeed()', err)
    }
  }
  ...
  async getAllFeeds (
    ...
    try {
      ...
      throw warnError('oracleHandler getAllFeeds()', err)
    }
  }
  ...
  async createFeed (oracleName: string): Promise<DDeliverTxResponse> {
    ...
    try {
      ...
      throw warnError('oracleHandler createFeed()', err)
    }
  }
  ...
  async pushToFeed (
    ...
    try {
      ...
      throw warnError('oracleHandler pushToFeed()', err)
    }
  }
